...
public class MainGLRenderer implements Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        Bitmap imageTitle = BitmapFactory.decodeResource(mContext.getResources(),
                mContext.getResources().getIdentifier("drawable/title", null,
                        mContext.getPackageName()));
        int imageTitleHandle = getImageHandle(imageTitle);
        mTitle.setBitmap(imageTitleHandle, 600, 600);
