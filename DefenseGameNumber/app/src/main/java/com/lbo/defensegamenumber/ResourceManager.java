...
public class ResourceManager {
    ...
    private static int[] mHandleSoldier = new int [2];
    private static int[] mHandleBigSoldier = new int [2];
    private static int mHandleBullet;
    private static int[] mHandleNumber = new int[10];
    // 화면확대축소관리
    ...
    // 리소스 로딩
    public void loadResource(Unit title, Unit[][] land, Button[] buttons, Zombie[] zombie, Bullet[] bullet){
        ...
        // 군인
        // soldier
        Bitmap soldier0 = BitmapFactory.decodeResource(mContext.getResources(),
                mContext.getResources().getIdentifier("drawable/soldier0", null,
                        mContext.getPackageName()));
        mHandleSoldier[0] = getImageHandle(soldier0);
        soldier0.recycle();

        Bitmap soldier1 = BitmapFactory.decodeResource(mContext.getResources(),
                mContext.getResources().getIdentifier("drawable/soldier1", null,
                        mContext.getPackageName()));
        mHandleSoldier[1] = getImageHandle(soldier1);
        soldier1.recycle();
        //[0].setBitmap(mHandleSoldier,200,200);

        Bitmap soldier2 = BitmapFactory.decodeResource(mContext.getResources(),
                mContext.getResources().getIdentifier("drawable/soldier2", null,
                        mContext.getPackageName()));
        mHandleBigSoldier[0] = getImageHandle(soldier2);
        soldier2.recycle();

        Bitmap soldier3 = BitmapFactory.decodeResource(mContext.getResources(),
                mContext.getResources().getIdentifier("drawable/soldier3", null,
                        mContext.getPackageName()));
        mHandleBigSoldier[1] = getImageHandle(soldier3);
        soldier3.recycle();

        Bitmap bmpBullet = BitmapFactory.decodeResource(mContext.getResources(),
                mContext.getResources().getIdentifier("drawable/bullet", null,
                        mContext.getPackageName()));
        ...
        for (int i = 0; i < 10; i++) {
            bmpNumber[i] = BitmapFactory.decodeResource(mContext.getResources(),
                    mContext.getResources().getIdentifier("drawable/num" + i, null,
                            mContext.getPackageName()));
    ...
    public static int[] getHandleSoldier(){
        return mHandleSoldier;
    }
    public static int[] getHandleBigSoldier(){
